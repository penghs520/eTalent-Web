            ...
            orgTable: {
                ...
                bar: [
                    /* 非必须，表格上面的操作栏配置 */
                    {
                        ...
                        method: this
                            .addOrg /* 必须，按钮点击时的回调，接收3个参数：搜索栏数据，单选框数据，多选框数据 */
                    },
                    {
                        type: "button" /* 必须，DOM类型：按钮 */,
                        text: "删除" /* 必须，按钮名称 */,
                        ...
                        method: this
                            .delOrg /* 必须，按钮点击时的回调，接收3个参数：搜索栏数据，单选框数据，多选框数据 */
                    },
                    {
                        type: "buttons" /* 下拉按钮 */,
                        text: "更多操作",
                        ...
                        list: [
                            /* 必须，更多按钮的数据组成的数组 */
                            {
                                text: "按钮1" /* 必须，按钮名称 */,
                                method: this
                                    .btn1 /* 必须，按钮点击时的回调，接收3个参数：搜索栏数据，单选框数据，多选框数据 */
                            },
                ...
                selectChange: this
                    .orgSelectChange /* 非必须，selcet选中改变时的回调，接收1个参数 */,
                ...
                pageSizeChange: this
                    .orgPageSizeChange /* 非必须，每页数量改变时的回调，接收5个参数：每页数量，搜索栏数据，单选框数据，多选框数据 */,
                pageChange: this
                    .orgPageChange /* 非必须，页码改变时的回调，接收5个参数：当前页码，搜索栏数据，单选框数据，多选框数据 */
            }
        };
    },
    components: {
